$(function(){
	...
	*/
    ...
    function randomImage(){
 	...
 	//eq(ranNum)을 넣음. 일단 svg애들을 3개 만들고 random으로 나오게!
 	//굳이 polyline points로 바꾸지 않고!
 	var a = $('#w_new polyline').index();
    var ranNum=Math.floor(Math.random()*a);
     console.log(ranNum);

    $('#w_new polyline').addClass("random");
	...
	*/
	...
	//Random W 방법2
	var imgNum=Math.floor(Math.random()*3	)+1; //1에~3밖에는 못나옴.
	document.write("<img src='images/img"+imgNum+".jpg'/>");
